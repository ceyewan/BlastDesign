...
namespace BlastDesign.tool.BlackBoxTest
{
    ...
    public class HoleChargeDrawing
    {
        ...
        public HoleChargeDrawing(int totalLength, int bottomChargeLength, int stemmingLength, int intervalLength, int chargeBlockLength)
        {
            TextInit();
            TotalLength = totalLength;
            BottomChargeLength = bottomChargeLength;
            StemmingLength = stemmingLength;
            IntervalLength = intervalLength;
            ChargeBlockLength = chargeBlockLength;
        ...
        public void DrawAndSave(string filePath)
        {
            ...
            var rect = SKRect.Create(2000, 300);
        ...
        public void DrawRedRectangles(float startLength, float endLength, float intervalLength, float rectLength)
        {
            ...
            if (startLength == 0)
            {
                startRect = new SKRect(currentX, BaselineY - 15, currentX + 1, BaselineY);
